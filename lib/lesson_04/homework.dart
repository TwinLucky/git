...
/// Завдання 4: Record
/// Створи   та не іменований (позиційний) record з твоїм ім'ям та віком і виведи обидва поля.
void record() {
  print('=== Завдання 4: Record');
  (String, int) point = ('Борис', 44); // позиційний не іменований
  print('Record: $point');
  ({String name, int age}) person = (name: 'Борис', age: 44); // іменований
  print('Record: $person');
}
